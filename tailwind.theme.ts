...
export const tailwindTheme: Omit<Config, "content"> = {
  darkMode: "class",
  theme: {
    container: {
      center: true,
    ...
    extend: {
      colors: {
        ...
        target: {
          area: {
            DEFAULT: "hsl(var(--target-area))",
            foreground: "hsl(var(--target-area-foreground))",
          },
          device: {
            DEFAULT: "hsl(var(--target-device))",
            foreground: "hsl(var(--target-device-foreground))",
          },
          entity: {
            DEFAULT: "hsl(var(--target-entity))",
            foreground: "hsl(var(--target-entity-foreground))",
          },
          label: {
            DEFAULT: "hsl(var(--target-label))",
            foreground: "hsl(var(--target-label-foreground))",
          },
        },
      },
      borderRadius: {
